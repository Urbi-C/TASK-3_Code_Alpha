...
let nameDsp = document.getElementById('fullname_dsp'),
    ...
    educationDsp = document.getElementById('education_dsp'),
...
const getUserInputs = () =>
{
    ...
    achievementsDescElem = document.querySelectorAll('.achieve_description');
    ...
    eduGraduationDateElem = document.querySelectorAll('.edu_grad_date'),
    eduDescriptionElem = document.querySelectorAll('.edu_description');

    //Project
    let projTitleElem = document.querySelectorAll('.proj_title'),
    projLinkElem = document.querySelectorAll('.proj_link'),
    projDescriptionElem = document.querySelectorAll('.proj_desc');
    ...
    achievementsDescElem.forEach(item=>item.addEventListener('keyup',(e)=>validateFormData(e.target,validType.ANY,'Description')));
    ...
    eduDegreeElem.forEach(item=>item.addEventListener('keyup',(e)=>validateFormData(e.target,validType.ANY,'City')));
    eduGraduationDateElem.forEach(item=>item.addEventListener('keyup',(e)=>validateFormData(e.target,validType.ANY,'Description')));
    projTitleElem.forEach(item =>item.addEventListener('keyup',(e)=>(e.target,validType.ANY,'Title')));
    ...
    return{
        ...
        achievements:fetchValues(['achieve_title','achieve_description'],achievementsTitleElem,achievementsDescElem),
...
const dispalyCV = (userData)=>
{
    nameDsp.innerHTML = userData.firstname + " " + userData.middlename + " " + userData.lastname;
    phoneDsp.innerHTML = userData.phoneno;
...
function previewImage()
{
    ...
    PicReader.readAsDataURL(imageElem.files[0]);
    PicReader.onload = function(ofEvent){imageDsp.src = ofEvent.target.result;}
}
